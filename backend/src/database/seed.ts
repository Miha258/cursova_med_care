...
async function seed() {
  ...
  await medicationRepo.save([
    ...
    medicationRepo.create({ name: 'Кетопрофен 100мг', quantity: 180, minQuantity: 40, expiryDate: '2026-10-31', unit: 'капс.', price: 42.00 }),
    ...
    medicationRepo.create({ name: 'Ципрофлоксацин 500мг', quantity: 150, minQuantity: 30, expiryDate: '2027-01-31', unit: 'таб.', price: 67.00 }),
    // Ендокринологія
    medicationRepo.create({ name: 'Метформін 500мг', quantity: 15, minQuantity: 100, expiryDate: '2026-09-30', unit: 'таб.', price: 32.00 }),
    medicationRepo.create({ name: 'Глібенкламід 5мг', quantity: 340, minQuantity: 50, expiryDate: '2027-03-31', unit: 'таб.', price: 28.50 }),
    ...
    medicationRepo.create({ name: 'Метоклопрамід 10мг', quantity: 410, minQuantity: 60, expiryDate: '2026-12-31', unit: 'таб.', price: 16.50 }),
    // Антигістамінні
